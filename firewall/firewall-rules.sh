...
iptables -A FORWARD -i eth1 -o eth2 -d 10.100.2.10 -p tcp --dport 502 -j ACCEPT
iptables -A FORWARD -i eth1 -o eth2 -d 10.100.2.10 -p tcp --sport 502 -j ACCEPT
iptables -A FORWARD -i eth2 -o eth1 -d 10.100.1.10 -p tcp --sport 502 -j ACCEPT
iptables -A FORWARD -i eth2 -o eth1 -d 10.100.1.10 -p tcp --dport 502 -j ACCEPT
...
echo "  MONITORING Network:   10.100.3.254"
echo ""
